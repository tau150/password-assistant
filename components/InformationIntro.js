...
function InformationIntro(){
  ...
  return (
    <Box as='section'>
      ...
      <Box as='article' py={8} px={[4, 20]}>
        <Heading as='h2' fontSize='3xl'>
          <FormattedMessage id='step1Title' defaultMessage='Create your Password Manager'/>
        </Heading>
        <Flex mt={8} w='100%' flexDirection={['column', 'row']}>
           <Flex w={['100%', '50%']} flexDir='column' alignItems='center'>
            <Image src={headImage} alt='head'/>
            <Text w={['100%', '50%']} textAlign='center'>
